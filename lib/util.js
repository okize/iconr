...
module.exports = {
  ...
  createCssRules: function(results, opts) {
    ...
    _.each(results, function(res, i) {
      ...
      str += ("." + (cssClassnamePrefix + res.name) + "{") + ("" + height) + ("" + width) + ("background-image:url(" + res.svgdatauri + ");") + "}" + (".no-inlinesvg ." + (cssClassnamePrefix + res.name) + "{") + ("background-image:url(" + res.pngdatauri + ");") + "}";
      if (!opts.nopng) {
