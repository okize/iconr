...
module.exports = {
  ...
  trimFilename: function trimFilename(filename) {
    var index = filename.lastIndexOf('.css');
    if (index !== -1) {
  ...
  optimizeSvg: function optimizeSvg(data) {
    var svgo = Promise.promisifyAll(new SvgOptimize());
