var Progger, Promise, TOO_BIG_FOR_IE8, _, fs, gzipSize, microtime, mkdirp, msg, p, path, rimraf, util;
...
module.exports = function(args, opts) {
  ...
  return fs.readdirAsync(inputDir).then(function(files) {
    ...
    var queue;
    pngPaths = _.filter(pngPaths, function(path) {
    ...
    if (!opts.nopngdata) {
      return results.forEach(function(res) {
        var ref, size;
        size = (ref = res.pngdatauri) != null ? ref.length : void 0;
